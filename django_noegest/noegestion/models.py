...
class Articles(models.Model):
    ...
    nom_court = models.CharField(max_length=32, db_index=True)
...
class Mouvements(models.Model):
    ...
    fournisseur = models.CharField(max_length=32, db_index=True, null=True, default='')
    ...
    service = models.IntegerField(default=3, help_text="Service repas concerné", null=True)
    nbrations = models.DecimalField(max_digits=8, decimal_places=4, help_text="Nbre de ration par qteMouvement", null=True)
