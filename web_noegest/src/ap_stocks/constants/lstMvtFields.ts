...
export const lstMvtFields: Record<PageOrigine, MvtFormField[]> = {
  "sorties": [
    ...
    { label: "Article", type: "text", fieldName: "article", subFieldName: "nom_court",width:145, justify: 'right'},
    { noLstDisplay:true, label: "Nom long", type: "text", fieldName: "article", subFieldName: "nom",width:165, justify: 'left'},
  ...
  "entrees": [
      ...
      { label: "PxUn", type: "number", fieldName: "prix_unit", width: 55, justify: 'right', nbDecimals: 3 },
      { noLstDisplay:true, label: "Rat ions", type: "number", fieldName: "rations", width: 55, justify: 'right', nbDecimals: 0 },
      { noLstDisplay:true, label: "Coût Un", type: "number", calcul: "coutUn", width: 55, justify: 'right', nbDecimals: 2 },
