# Generated by Django 4.2.3 on 2024-12-07 19:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['jour'], name='noegestion__jour_df56f6_idx')],
            },
        ),
        migrations.CreateModel(
            name='StArticle',
            fields=[
                ...
                ('saisie', models.DateField(auto_now=True, help_text="Date de l'entrée de l'item")),
                ('obsolete', models.BooleanField(default=False)),
                ('fournisseur', models.ForeignKey(default=1, help_text='Fournisseur habituel', on_delete=django.db.models.deletion.RESTRICT, related_name='articles', to='noegestion.stfournisseur')),
                ('magasin', models.ForeignKey(help_text='Lieu de stockage', on_delete=django.db.models.deletion.DO_NOTHING, to='noegestion.stmagasin')),
                ('rayon', models.ForeignKey(default=1, help_text='Catégorie de produit', on_delete=django.db.models.deletion.RESTRICT, related_name='articles', to='noegestion.strayon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qtemouvement', models.DecimalField(decimal_places=2, help_text="Nombre d'unités en mouvement", max_digits=8)),
                ('prixunit', models.DecimalField(decimal_places=4, max_digits=10)),
                ('service', models.IntegerField(choices=[(0, '-'), (1, 'matin'), (2, 'midi'), (3, 'soir'), (4, '5eme'), (5, 'tous')], default=0, help_text='Service repas concerné')),
                ('nbrations', models.DecimalField(decimal_places=4, help_text='Nbre de ration par unité Mouvement', max_digits=8, null=True)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['jour', 'article', 'sens', 'origine'], name='noegestion__jour_85e0a5_idx'), models.Index(fields=['article', 'sens', 'jour'], name='noegestion__article_0cc27b_idx')],
            },
        ),
        migrations.CreateModel(
            name='StInventaire',
            ...
            options={
                ...
                'indexes': [models.Index(fields=['jour', 'article'], name='noegestion__jour_87c9e9_idx')],
            },
        ),
    ]
